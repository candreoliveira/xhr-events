...
/***/ function(module, exports, __webpack_require__) {
	...
	eval("'use strict';\n\nvar _createClass = (function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; })();\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _objectAssign = __webpack_require__(2);\n\nvar _objectAssign2 = _interopRequireDefault(_objectAssign);\n\nvar _xhrTiming = __webpack_require__(3);\n\nvar _xhrTiming2 = _interopRequireDefault(_xhrTiming);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar XHREvent = (function () {\n  function XHREvent() {\n    _classCallCheck(this, XHREvent);\n  }\n\n  _createClass(XHREvent, null, [{\n    key: 'start',\n    value: function start(xhrHelper, XMLHttpRequest) {\n      XMLHttpRequest.prototype.open = function () {\n        var xhrTiming = new _xhrTiming2.default();\n\n        this.onloadstart = function (XMLHttpRequestEventTarget) {\n          xhrTiming.loadStartDate = new Date();\n          xhrHelper.dispatchNewMessage('XHRLoadStart', (0, _objectAssign2.default)({ XMLHttpRequestEventTarget: XMLHttpRequestEventTarget }, xhrTiming.dates()));\n        };\n\n        this.onloadend = function (XMLHttpRequestEventTarget) {\n          xhrTiming.loadEndDate = new Date();\n          xhrHelper.dispatchNewMessage('XHRLoadEnd', (0, _objectAssign2.default)({ XMLHttpRequestEventTarget: XMLHttpRequestEventTarget }, xhrTiming.dates()));\n        };\n\n        this.onload = function (XMLHttpRequestEventTarget) {\n          xhrTiming.loadDate = new Date();\n          xhrHelper.dispatchNewMessage('XHRLoad', (0, _objectAssign2.default)({ XMLHttpRequestEventTarget: XMLHttpRequestEventTarget }, xhrTiming.dates()));\n        };\n\n        this.onabort = function (XMLHttpRequestEventTarget) {\n          xhrTiming.abortDate = new Date();\n          xhrHelper.dispatchNewMessage('XHRAbort', (0, _objectAssign2.default)({ XMLHttpRequestEventTarget: XMLHttpRequestEventTarget }, xhrTiming.dates()));\n        };\n\n        this.ontimeout = function (XMLHttpRequestEventTarget) {\n          xhrTiming.timeoutDate = new Date();\n          xhrHelper.dispatchNewMessage('XHRTimeout', (0, _objectAssign2.default)({ XMLHttpRequestEventTarget: XMLHttpRequestEventTarget }, xhrTiming.dates()));\n        };\n\n        this.onerror = function (XMLHttpRequestEventTarget) {\n          xhrTiming.errorDate = new Date();\n          xhrHelper.dispatchNewMessage('XHRError', (0, _objectAssign2.default)({ XMLHttpRequestEventTarget: XMLHttpRequestEventTarget }, xhrTiming.dates()));\n        };\n\n        this.onprogress = function (XMLHttpRequestEventTarget) {\n          xhrTiming.progressDates = xhrTiming.progressDates.concat([new Date()]);\n          xhrHelper.dispatchNewMessage('XHRProgress', (0, _objectAssign2.default)({ XMLHttpRequestEventTarget: XMLHttpRequestEventTarget }, xhrTiming.dates()));\n        };\n\n        xhrHelper.xmlHttpRequestOpen.apply(this, arguments);\n      };\n    }\n  }]);\n\n  return XHREvent;\n})();\n\nexports.default = XHREvent;\n\n/*****************\n ** WEBPACK FOOTER\n ** ./src/xhrEvent.js\n ** module id = 1\n ** module chunks = 0\n **/\n//# sourceURL=webpack:///./src/xhrEvent.js?");
